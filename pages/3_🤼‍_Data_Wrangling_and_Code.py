...
st.title("Data Wrangling and Code Copies 🧼 🤼‍♂️ 🐍 🐮🤠 👨🏿‍💻 💻")
...
#NOTE Introduction
st.title("Superstore Filter Page :convenience_store: 🔍")
...
with pic1:
    ...
    lottie_credit("Image created by Мария Ящук (Maria Yashchuk) Lottiefiles.")
with pic2:
    internet = load_lottieurl("https://assets2.lottiefiles.com/packages/lf20_sz668bkw.json")
    st_lottie(internet, height = 300, key = "internet_shopping")
    lottie_credit("Image was created by Hadii Hassan LottieFiles.")
